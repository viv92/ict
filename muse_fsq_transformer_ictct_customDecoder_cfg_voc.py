...
if __name__ == '__main__':
    ...
    num_train_steps_per_diffusion_process = 70
    ...
    save_folder = './generated_muse_fsq_transformer_ictct_customDecoder_cfg_voc' + hyperparam_str
    ...
    muse_ckpt_path = './ckpts/muse_fsq_transformer_ictct_customDecoder_cfg_voc' + hyperparam_str + '.pt'
