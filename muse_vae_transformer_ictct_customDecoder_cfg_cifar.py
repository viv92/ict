...
if __name__ == '__main__':
    ...
    N_initial = 350 # 2 # 10  # starting value of N in the step schedule (denoted as s_0 in appendix C) - starting from a low value yeilds a decreasing loss curve, while starting from a high value yeilds almost flat loss curve
    N_final = 1023 # 150 # 1023 # final value of N in the step schedule (denoted as s_1 in appendix C)
    ...
    save_folder = './generated_muse_vae_transformer_ictct_customDecoder_cfg_cifar' + hyperparam_str
    ...
    muse_ckpt_path = './ckpts/muse_vae_transformer_ictct_customDecoder_cfg_cifar' + hyperparam_str + '.pt'
