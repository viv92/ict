...
if __name__ == '__main__':
    ...
    save_folder = './generated_muse_vae_transformer_ictct_customDecoder_cfg_mnist' + hyperparam_str
    ...
    muse_ckpt_path = './ckpts/muse_vae_transformer_ictct_customDecoder_cfg_mnist' + hyperparam_str + '.pt'
